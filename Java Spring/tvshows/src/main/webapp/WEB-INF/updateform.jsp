...
<body>
       ...
       <div class="formContainer">
        <!-- FORM INPUT SECTION -->
       <h1>Update ${editshow.title}</h1>
       <form:form action="/shows/${editshow.id}/edit" method="POST" modelAttribute="show">
			   <input type="hidden" name="_method" value="PUT"> 
			 <form:input path="showCreator" type="hidden" class="input" value="${user.id}"/>
			 <form:input path="id" type="hidden" class="input" value="${editshow.id}"/>
			  <form:errors path="showCreator" class="errors"/>
        
            <div>
                <div class="formation">
                    <form:label path="title"> Show Title </form:label>	
                    <form:input path="title" class="input"  value="${editshow.title}" />
                </div>
                <div class="errors">
            ...
            <div>
                <div class="formation">
                    ...
                    <form:input path="rating" type="number" step="1" min="1" class="input"  value="${editshow.rating}" />
                </div>
                <div class="errors">
            ...
            <div>
                <div class="formation">
                    ...
                    <form:input path="description" class="input"  value="${editshow.description}"/>
                </div>
                <div class="errors">
